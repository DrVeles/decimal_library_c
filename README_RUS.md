...
- Реализуй описанные выше функции. 
...
- При реализации decimal ориентируйся на двоичное представление с целочисленным массивом `bits`, Соблюдай положение разрядов числа в массиве `bits`;
